%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% This file is used for plotting a histogram of all the p values
% that resulted in a number of days open within 10% of the maximum number
% of days open. In the file we use defineParameters to randomly 
% choose different parameters. We then run the the covid feedback 
% solver for the randomly chosen variable.
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
...
for j = 1:10
    ...
    [f, B1, B2, b1, b3, B3, vR_U, gamma] = defineParameters(f, 1, 0, 0, 0, 0, 1, 0, 0, 0);
    
    params = [f, B1, B2, b1, b3, B3, gamma];
