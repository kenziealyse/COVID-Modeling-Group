...
function [f, B1, B2, b1, b3, B3, vR_U, gamma] = defineParameters(fb, B1b, B2b...
...
% If gamma == 1 then randomize the value for gamma. Else, set gamma = 1/90

if gammab == 1
    
    gamma_start = gamma_vec(1);
    gamma_end = gamma_vec(end);
    gamma = (gamma_end-gamma_start).*rand(1) + gamma_start;
