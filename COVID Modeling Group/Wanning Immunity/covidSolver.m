...
function [T, S, I1u, I1a, I2, R] = covidSolver(param, tR, vR, init_cond, tspan, event, plotn)
    ...
    [T,y] = ode23s(@(t,Y) covid(t,Y,vR,tR,f,B1,B2,b1,b3,B3, gamma) , tspan ,...
    init_cond, Opt);
...
function dY_dt = covid(~,Y,vR,tR,f,B1,B2,b1,b3,B3,gamma)
