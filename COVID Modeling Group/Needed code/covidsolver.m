    function [T, S, I1u, I1a, I2, R] = covidsolver(param, tR, vR, init_cond, tspan, event_chk, plotn)
    ...
    %if event_chk == 1 then use the stopping criteria in the event function   
...
vR_eval = vR(t); % vR as a function of time (for a non-super spreading event, vR_high and vR_low should be the same)

tR_eval = tR(t, S, I1u); % tR as a function of time and sucepstibles
...
value      = Y(3) + Y(4) - 0.05; 
isterminal = 1;   % HALT INTEGRATION WHEN I1U = 0.05
direction  = 0;
